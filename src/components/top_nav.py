...
class AdminTopNavigation(ft.Container):
    """
    Transparent top navigation for admin pages with Dashboard and Employees buttons
    """
    def __init__(self, page: ft.Page):
        ...
        self.employees_btn = ft.TextButton(
            text="Employees",
            icon=ft.Icons.PEOPLE,
            on_click=lambda e: self.page.go("/admin/employees"),
            style=ft.ButtonStyle(
                color=ft.Colors.WHITE,
                overlay_color=ft.Colors.with_opacity(0.1, ft.Colors.WHITE),
            )
        ...
        self.content = ft.Row(
            controls=[
                ...
                ft.Container(
                    content=ft.Row(
                        controls=[self.dashboard_btn, self.employees_btn],
                        spacing=20
                    ),
